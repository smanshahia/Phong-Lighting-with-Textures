...
int main()
{
	...
	unsigned int VBO, cratesVAO;
	glGenVertexArrays(1, &cratesVAO);
	glGenBuffers(1, &VBO);

	glBindVertexArray(cratesVAO);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 model;
		model = glm::translate(model, glm :: vec3(sin(glfwGetTime()) * 2, cos(glfwGetTime()) * 2, 0));
		model = glm::scale(model, glm::vec3(1.2f)); // bigger cube
	...
	// ------------------------------------------------------------------------
	glDeleteVertexArrays(1, &cratesVAO);
